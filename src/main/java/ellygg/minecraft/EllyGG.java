...
public class EllyGG implements ModInitializer {
    ...
    /*
        Crafting recipes
            ...
            - netherrack = gravel + blaze powder
                Like this recipe and probably going to keep
                Netherrack is weak so didn't want to make out of a durable block like stone
                Wanted a source of heat to create it.  Chose blaze powder over lava bucket
                Gravel and blaze powder are both renewable in the nether
